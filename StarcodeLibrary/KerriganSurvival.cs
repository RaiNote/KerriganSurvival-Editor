...
namespace StarcodeLibrary
{
    internal class KerriganSurvival : Map
    {
        ...
        {
            ArrayList[lpWhichList].LvArray[ArrayList[lpWhichList].LvArray.Count] = lpValue;
            //ArrayList[lpWhichList].LvArray.Count = (ArrayList[lpWhichList].LvArray.Count + 1);
        }
    }
}